...
const LANGS = {
  ko: {
    ...
    navPrivacy: '개인정보처리방침', navTerms: '이용약관', navContact: '문의하기',
    howToTitle: '📖 사용 방법',
  ...
  en: {
    ...
    navPrivacy: 'Privacy Policy', navTerms: 'Terms', navContact: 'Contact',
  ...
  zh: {
    ...
    navPrivacy: '隐私政策', navTerms: '条款', navContact: '联系我们',
    howToTitle: '📖 使用方法',
  ...
  ja: {
    ...
    navPrivacy: 'プライバシーポリシー', navTerms: '利用規約', navContact: 'お問い合わせ',
    howToTitle: '📖 使い方',
